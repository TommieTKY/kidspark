...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <section class="w3-padding">
            ...
            <form action="{{ route('programs.store') }}" method="POST"  novalidate class="w3-margin-bottom">
                {{ csrf_field() }}
                <div class="w3-margin-bottom">
                    ...
                    <input type="number" name="price" placeholder="Price" value="{{ old('price') }}" required>
                ...
                <button type="submit" class="w3-button w3-green">Add Program</button>
            </form>
